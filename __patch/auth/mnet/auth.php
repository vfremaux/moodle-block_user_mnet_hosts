    ...
    function confirm_mnet_session($token, $remotepeer) {
        ...
        if (empty($localuser) || ! $localuser->id) {
            ...
            */
            ...
            // PATCH+ : Simple insertion without event triggering.
        ...
        // PATCH+ : check mnet auth methods and capture profile fields, check if corresponding entry is defined and update data.
